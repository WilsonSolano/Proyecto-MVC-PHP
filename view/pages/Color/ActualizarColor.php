    ...
    <form action="?c=<?php echo base64_encode('Color').'&a='.base64_encode('ActualizarColorDB')?>" method="post">
        <main class="container ml-1 mr-5 mt-4 border border-success">
            ...
            <div class="input-group mb-3">
                ...
                <input type="number" class="form-control" placeholder="12345" aria-label="Nombre" aria-describedby="basic-addon1" value="<?php echo base64_decode($_REQUEST["idcolor"])?>">
            </div>
            <div class="input-group mb-5">
                <span class="input-group-text" id="basic-addon1">Nombre: </span>
                <input type="text" class="form-control" placeholder="Nombre" aria-label="Nombre" aria-describedby="basic-addon1" value="<?php echo base64_decode($_REQUEST["nombrecolor"])?>">
